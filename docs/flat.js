...
request.addEventListener('load', function (e) {
  ...
  JSON.parse(this.responseText).data.forEach(function (el) {
    if (!el.attributes.multimedia[0] || !el.attributes.multimedia[0].enhancement || !el.attributes.multimedia[0].enhancement.rekognition[0] || el.attributes.multimedia[0].enhancement.rekognition[0].report  ) {
      getObject();
      return;
    }
